...
const GAME_CONFIG = {
  ...
  teams: {
    ...
    "GRIFFIN-2": { name: "그리핀도르 2팀", house: "gryffindor", displayName: "🦁 그리핀도르 2", verse: "내가 사망의 음침한 골짜기로 다닐지라도 해를 두려워하지 않을 것은 주께서 나와 함께 하심이라 — 시편 23:4" },
    "GRIFFIN-3": { name: "그리핀도르 3팀", house: "gryffindor", displayName: "🦁 그리핀도르 3", verse: "우리가 낙심하지 아니하노니 겉사람은 낡아지나 우리의 속사람은 날로 새로워지도다 — 고린도후서 4:16" },
    "GRIFFIN-4": { name: "그리핀도르 4팀", house: "gryffindor", displayName: "🦁 그리핀도르 4", verse: "하나님이 우리에게 주신 것은 두려워하는 마음이 아니요 오직 능력과 사랑과 절제하는 마음이니 — 디모데후서 1:7" },
    "GRIFFIN-5": { name: "그리핀도르 5팀", house: "gryffindor", displayName: "🦁 그리핀도르 5", verse: "사람이 친구를 위하여 자기 목숨을 버리면 이보다 더 큰 사랑이 없나니 — 요한복음 15:13" },
    "GRIFFIN-6": { name: "그리핀도르 6팀", house: "gryffindor", displayName: "🦁 그리핀도르 6", verse: "믿음으로 말미암아 우리는 의롭다 하심을 받고 하나님과 화평을 누리자 — 로마서 5:1" },
    "SLYTH-1":   { name: "슬리데린 1팀",   house: "slytherin",  displayName: "🐍 슬리데린 1",   verse: "너는 마음을 다하여 여호와를 신뢰하고 네 명철을 의지하지 말라 — 잠언 3:5" },
    "SLYTH-2":   { name: "슬리데린 2팀",   house: "slytherin",  displayName: "🐍 슬리데린 2",   verse: "무릇 지킬 만한 것보다 더욱 네 마음을 지키라 생명의 근원이 이에서 남이니라 — 잠언 4:23" },
    "SLYTH-3":   { name: "슬리데린 3팀",   house: "slytherin",  displayName: "🐍 슬리데린 3",   verse: "모든 것이 합력하여 선을 이루느니라 — 로마서 8:28" },
    "SLYTH-4":   { name: "슬리데린 4팀",   house: "slytherin",  displayName: "🐍 슬리데린 4",   verse: "너희 안에서 착한 일을 시작하신 이가 그리스도 예수의 날까지 이루실 줄을 우리는 확신하노라 — 빌립보서 1:6" },
    "SLYTH-5":   { name: "슬리데린 5팀",   house: "slytherin",  displayName: "🐍 슬리데린 5",   verse: "내게 능력 주시는 자 안에서 내가 모든 것을 할 수 있느니라 — 빌립보서 4:13" },
    "SLYTH-6":   { name: "슬리데린 6팀",   house: "slytherin",  displayName: "🐍 슬리데린 6",   verse: "우리가 선을 행하되 낙심하지 말지니 포기하지 아니하면 때가 이르매 거두리라 — 갈라디아서 6:9" },
    "RAVEN-1":   { name: "래번클로 1팀",   house: "ravenclaw",  displayName: "🦅 래번클로 1",   verse: "진리를 알지니 진리가 너희를 자유롭게 하리라 — 요한복음 8:32" },
    "RAVEN-2":   { name: "래번클로 2팀",   house: "ravenclaw",  displayName: "🦅 래번클로 2",   verse: "주의 말씀은 내 발에 등이요 내 길에 빛이니이다 — 시편 119:105" },
    "RAVEN-3":   { name: "래번클로 3팀",   house: "ravenclaw",  displayName: "🦅 래번클로 3",   verse: "여호와를 경외하는 것이 지혜의 근본이라 — 잠언 9:10" },
    "RAVEN-4":   { name: "래번클로 4팀",   house: "ravenclaw",  displayName: "🦅 래번클로 4",   verse: "여호와를 앙망하는 자는 새 힘을 얻으리니 독수리가 날개치며 올라감 같을 것이요 — 이사야 40:31" },
    "RAVEN-5":   { name: "래번클로 5팀",   house: "ravenclaw",  displayName: "🦅 래번클로 5",   verse: "처음도 없고 끝도 없으신 하나님, 그 말씀은 영원히 서 있으리로다 — 이사야 40:8" },
    "RAVEN-6":   { name: "래번클로 6팀",   house: "ravenclaw",  displayName: "🦅 래번클로 6",   verse: "내가 너희에게 분부한 모든 것을 가르쳐 지키게 하라 — 마태복음 28:20" },
    "HUFFL-1":   { name: "후플푸프 1팀",   house: "hufflepuff", displayName: "🦡 후플푸프 1",   verse: "사랑은 오래 참고 사랑은 온유하며 시기하지 아니하며 — 고린도전서 13:4" },
    "HUFFL-2":   { name: "후플푸프 2팀",   house: "hufflepuff", displayName: "🦡 후플푸프 2",   verse: "서로 짐을 지라 그리하여 그리스도의 법을 성취하라 — 갈라디아서 6:2" },
    "HUFFL-3":   { name: "후플푸프 3팀",   house: "hufflepuff", displayName: "🦡 후플푸프 3",   verse: "너희 중에 누구든지 크고자 하는 자는 너희를 섬기는 자가 되어야 하리라 — 마태복음 20:26" },
    "HUFFL-4":   { name: "후플푸프 4팀",   house: "hufflepuff", displayName: "🦡 후플푸프 4",   verse: "우리가 사랑함은 그가 먼저 우리를 사랑하셨음이라 — 요한일서 4:19" },
    "HUFFL-5":   { name: "후플푸프 5팀",   house: "hufflepuff", displayName: "🦡 후플푸프 5",   verse: "항상 기뻐하라 쉬지 말고 기도하라 범사에 감사하라 — 데살로니가전서 5:16-18" },
    "HUFFL-6":   { name: "후플푸프 6팀",   house: "hufflepuff", displayName: "🦡 후플푸프 6",   verse: "내가 너를 지명하여 불렀나니 너는 내 것이라 — 이사야 43:1" },
  },
